...
public abstract class CustomComponent implements IMinecraft {
   ...
   public boolean isHovered(float mouseX, float mouseY) {
      return GuiUtil.isHovered((double)this.x, (double)this.y, (double)this.width, (double)this.height, (double)mouseX, (double)mouseY);
   }

   public boolean isHovered(double mouseX, double mouseY) {
      return GuiUtil.isHovered((double)this.x, (double)this.y, (double)this.width, (double)this.height, mouseX, mouseY);
   }
