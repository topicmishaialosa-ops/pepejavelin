...
public class ButtonComponent extends Component {
   ...
   public void render(CustomDrawContext draw, Theme theme, float mouseX, float mouseY, float alpha) {
      ...
      draw.drawText(Fonts.REGULAR.getFont(5.5F), this.setting.getName(), this.x + this.width / 2.0F - Fonts.REGULAR.getWidth(this.setting.getName(), 5.5F) / 2.0F, this.y + 5.0F, (new ColorRGBA(222, 222, 222)).withAlpha(255.0F * alpha));
   }
