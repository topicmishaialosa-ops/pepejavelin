      ...
      if (!this.needToClose) {
         this.savedRunnable = new Runnable() {
            public void run() {
               ...
               drawContext.drawText(Fonts.REGULAR.getFont(7.0F), RenamePasterClient.getClientName(), (float)(x + 92), (float)(y + 13), new ColorRGBA(67, 67, 67, MenuScreen.this.openAnimation.getValue() * 255.0F));
               ...
               drawContext.drawText(Fonts.REGULAR.getFont(7.0F), RenamePasterClient.getClientName(), (float)(x + 22), (float)(y + 10), new ColorRGBA(247, 251, 252, MenuScreen.this.openAnimation.getValue() * 255.0F));
